...
public class editpanenactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etSatuan.setText(getIntent().getStringExtra("SATUAN"));
        etHarga.setText(String.valueOf(getIntent().getIntExtra("HARGA", 0)));
        etKet.setText(getIntent().getStringExtra("KET"));
        ...
        btnSimpan.setOnClickListener(v -> {
            ...
            if (nama.isEmpty() || tanggal.isEmpty() || jumlah.isEmpty() || satuan.isEmpty() || hargaStr.isEmpty()) {
                ...
                try {
                    ...
                    boolean isUpdated = dbHelper.updateData(id, nama, tanggal, jumlah, satuan, harga, ket);
                    if (isUpdated) {
